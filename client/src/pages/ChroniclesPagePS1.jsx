...
const PREFIX = 'ChroniclesPagePS1';
...
function ChroniclesPagePS1() {
	...
	const { isLoading, error, data } = useQuery('PS1_Chronicles', () =>
		fetch('/api/chroniclesps1').then((res) => res.json())
	);

	useEffect(() => {
		// axios.get('/api/chroniclesps1').then((resp) => {
		// 	setData(resp.data);
		// });
...
export default ChroniclesPagePS1;
